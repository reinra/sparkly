...
import { Color, HslColor } from "../color/Color";
...
export class PaletteParameters {
    ...
    private readonly type: OptionEffectParameter = this.parameters.register({
        ...
        options: [
            ...
            { value: PaletteType.RandomSaturatedHsl, label: 'Random Saturated', description: 'Generate random saturated colors in HSL space' },
        ],
    }, () => this.onUpdate());
